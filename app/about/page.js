  ...
  return (
    ...
    >
      ...
      <div className="h-full overflow-scroll lg:flex" ref={containerRef}>
        {/* Text container */}
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 l:gap-48 xl:gap-54 lg:w-2/3 lg:pr-0 xl:w-1/2">
          {/* Bio */}
              ...
              <div className="flex justify-between h-fit">
                ...
                <div className="w-1/6 flex justify-center">
                  ...
                  <div className="w-1 h-full bg-gray-600 rounded relative">
                    {/* CIRCLE */}
                    <div className="absolute h-5 w-5 rounded-full ring-4 ring-red-300 bg-white -left-2"></div>
                  </div>
                </div>
                {/* RIGHT */}
